...
export const VideoSideBar = ({ playing }) => {
  ...
  return (
    <video
      ref={vidRef}
      src="img/projects/IMG_3616.MOV"
      id="video"
      className="responsive-video"
      controls="controls"
      autoPlay={false}
      poster="img/projects/Untitled-5.jpg"
    />
  );
};
  ...
  return (
    <div className="videocontainer">
      <iframe
        ...
        src="https://www.youtube.com/embed/Hab2C4VWjcQ?enablejsapi=1&version=3&playerapiid=ytplayer"
      />
    </div>
  );
};
    ...
    >
      ...
      >
        <Carousel.Item className="carousel-item" interval={1000}>
          <img src="img/projects/Untitled-1.jpg" alt="slide 1" />
        </Carousel.Item>
        <Carousel.Item className="carousel-item" interval={1000}>
          <img src="img/projects/Untitled-5.jpg" alt="slide 2" />
        </Carousel.Item>
        {/* <Carousel.Item className="carousel-item" interval={1000}>
